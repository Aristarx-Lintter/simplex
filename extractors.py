...
class ProductBatchLoader(IterableDataset):
    def __init__(self, X_mess, P_mess, X_bloch, P_bloch, tokenizer,
                 batches_per_epoch, batch_size, device):
        # ожидаем CPU тензоры на входе
...
def build_mixture_zip_dataset(config, device, concationation='decart'):
